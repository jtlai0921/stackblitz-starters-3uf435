/**
 * API: SPEC07010201-定期存款-本金利息明細查詢
 */
...
import { SPEC07010201Req } from './spec07010201-req';
// -- Other Library -- //

@Injectable()
export class SPEC07010201ApiService extends ApiBaseService {
    protected serviceId = 'SPEC07010201'; // API Name
    ...
    getPageData(reqData: object, option?: object, paginator?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC07010201Req, {
            'reqData': reqData,
            'paginator': paginator
        });
        // 欄位檢核
