...
export class ForeignLoanCurrencyService {
    /**
     * 參數處理
     */
    ...
    constructor(
        ...
        private spec10030001: SPEC10030001ApiService
    ) {
