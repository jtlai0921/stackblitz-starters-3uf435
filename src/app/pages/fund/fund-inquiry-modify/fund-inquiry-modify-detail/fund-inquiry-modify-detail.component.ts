...
export class FundInquiryModifyDetailComponent implements OnInit, OnChanges, OnDestroy , AfterViewInit{
...
onErrorPageData(item) {
  ...
  private getListData(reqData, page, sort?: string) {
    ...
    this.FundInquiryModifyService.getListData(reqData, paginator, option).then(
      (result) => {
