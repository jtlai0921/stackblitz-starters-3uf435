...
@Component({
  selector: 'app-fund-inquiry-modify-main',
  templateUrl: './fund-inquiry-modify-main.component.html',
  styleUrls: []
})

export class FundInquiryModifyMainComponent implements OnInit {
    // bookmarkData = []; // 頁籤設定
    // searchBoxRule: any;
    ...
    constructor(
        private FundInquiryModifyService : FundInquiryModifyService,
    ...
    private _initEvent() {
        ...
        this.FundInquiryModifyService.removeAllCache();
        this.hasInit = true;
        this._logger.log("godetail:",this.godetail);
    }
    ...
    onOpen() {
        ...
        this.FundInquiryModifyService.changeExpandSubject(this.expandFlag);
    }
    ...
    onScrollEvent(next_page) {
        ...
        let componentRef: any = this.paginatorCtrl.addPages(this.nowAppendBox, FundInquiryModifyDetailComponent);
