...
export class FundProfitLossService {
    /**
     * 參數處理
     */
    ...
    constructor(
        ...
        private spec11070101: SPEC11070101ApiService
    ) {
    }
    ...
    getBookmark() {
        ...
        output.push({
            id: '1M',
            name: 'DEPOSIT.SEARCH.MONTH', // 最近一個月
            sort: 2,
        ...
        output.push({
            id: '3M',
            name: 'DEPOSIT.SEARCH.3MONTH', // 最近三個月
            sort: 3,
    ...
    getListData(reqData: object, paginator: object, option?: object): Promise<any> {
        ...
        return this.spec11070101.getPageData(reqData, option, paginator).then(
            (sucessObj) => {
    ...
    getNoteData() {
        let noteData = {
            title: 'POPUP.FUNDPROFITLOSS.TITLE',
            // content: 'POPUP.NOTE.FOREIGN_DATE'
            content: 'POPUP.FUNDPROFITLOSS.FUNDPROFITLOSS_NOTE'
        };
        return noteData;
    }
