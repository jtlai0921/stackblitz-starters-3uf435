...
export class STDetailInqRqService {
    ...
    /**
     * [API] 取得結構型明細之上行電文 CCMPTX000189Rq
     * @param requestObj 
     * requestObj = {
     *  'Country': '', 帳戶國別
     *  'CustomerId': '', 帳戶統編
     ...
     * }
     */
    public getSTDetail(requestObj: Object) {
        // 取得並設定參數
        let value = {};
        const request = this.telegram.GetRequstParam('CCMPTX000189Rq');       
